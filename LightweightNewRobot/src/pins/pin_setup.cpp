...
void Pin::pwmInit()
{
		...
		else if(m_timer1 == TIM9)
		{
			RCC_APB2PeriphClockCmd(m_tim1, ENABLE);
		}
		else if(m_timer1 == TIM10)
		{
			RCC_APB2PeriphClockCmd(m_tim1, ENABLE);
		}
		else if(m_timer1 == TIM11)
		{
			RCC_APB2PeriphClockCmd(m_tim1, ENABLE);
		}
		else if(m_timer1 == TIM8)
		{
			RCC_APB2PeriphClockCmd(m_tim1, ENABLE);
		}
		else 
		...
		if(m_tim1 == RCC_APB2Periph_TIM1|| m_tim1 == RCC_APB2Periph_TIM8)
		{
			...
			ch1.TIM_BreakPolarity = TIM_BreakPolarity_Low;
		...
		if(m_tim1 != RCC_APB2Periph_TIM1|| m_tim1 != RCC_APB2Periph_TIM8)ch.TIM_OutputNState = TIM_OutputNState_Disable;
		...
		if(m_tim1 != RCC_APB2Periph_TIM1|| m_tim1 != RCC_APB2Periph_TIM8)ch.TIM_OCIdleState = TIM_OCIdleState_Set;
		else ch.TIM_OCIdleState = TIM_OCIdleState_Reset;
		if(m_tim1 != RCC_APB2Periph_TIM1|| m_tim1 != RCC_APB2Periph_TIM8)ch.TIM_OCNIdleState = TIM_OCNIdleState_Set;
		...
		if(m_tim1 == RCC_APB2Periph_TIM1|| m_tim1 == RCC_APB2Periph_TIM8)TIM_CtrlPWMOutputs(m_timer1, ENABLE);
}
